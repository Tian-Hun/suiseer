...
export const Hero: React.FC = () => {
    ...
    return (
        <section className="h-screen w-full relative flex justify-center overflow-hidden">
            <h1 className="absolute top-200px z-10 text-66px text-white font-bold">Unveil Your Destiny in the Web3 Era</h1>
            ...
            <MouseScroll className="absolute bottom-20px z-10" />
            <div
